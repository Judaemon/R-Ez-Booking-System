    ...
    public function run()
    {
        ...
        $rooms = [
            ...
            [
                ...
                'maximum_capacity' => '5',
                'image_paths' => json_encode(['kubo_fan_room/kubo1.jpg', 'kubo_fan_room/kubo2.jpg', 'kubo_fan_room/kubo3.jpg']),
            ...
            [
                ...
                'maximum_capacity' => '5',
                'image_paths' => json_encode(['superior_room/superior1.jpg', 'superior_room/superior2.jpg', 'superior_room/superior3.jpg']),
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ],
            // //Villa
            [
                ...
                'maximum_capacity' => '5',
                'image_paths' => json_encode(['villa_room/villa1.jpg', 'villa_room/villa2.jpg', 'villa_room/villa3.jpg']),
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ],
            // //Bhut Couple
            [
                ...
                'recommended_capacity' => '2',
                'maximum_capacity' => '5',
                'image_paths' => json_encode(['couple_bhut/couple1.jpg', 'couple_bhut/couple2.jpg', 'couple_bhut/couple3.jpg']),
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ],
            // //Bhut Regular
            [
                ...
                'recommended_capacity' => '2',
                'maximum_capacity' => '5',
                'image_paths' => json_encode(['regular_bhut/regular1.jpg', 'regular_bhut/regular2.jpg', 'regular_bhut/regular3.jpg', 'regular_bhut/regular4.jpg', 'regular_bhut/regular5.jpg']),
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ],
            // //Bhut Barkada
            [
                ...
                'maximum_capacity' => '5',
                'image_paths' => json_encode(['barkada_bhut/barkada1.jpg', 'barkada_bhut/barkada2.jpg', 'barkada_bhut/barkada3.jpg', 'barkada_bhut/barkada4.jpg', 'barkada_bhut/barkada5.jpg']),
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ],
        ];
