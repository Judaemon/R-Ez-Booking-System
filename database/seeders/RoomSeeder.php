    ...
    public function run()
    {
        ...
        $rooms = [
            ...
            [
                ...
                'image_path' => 'kubo_fan_room/kubo1.jpg',
            ...
            [
                ...
                'image_path' => 'superior_room/superior1.jpg',
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ],
            [
            ...
            [
                ...
                'image_path' => 'villa_room/villa1.jpg',
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ],
            //Bhut Couple
            [
                ...
                'price' => '3300.00',
                'recommended_capacity' => '2',
                'image_path' => 'couple_bhut/couple1.jpg',
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ],
            //Bhut Regular
            [
                ...
                'price' => '4300.00',
                'recommended_capacity' => '2',
                'image_path' => 'regular_bhut/regular1.jpg',
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ],
            [
            ...
            [
                ...
                'image_path' => 'barkada_bhut/barkada1.jpg',
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ],
            [
