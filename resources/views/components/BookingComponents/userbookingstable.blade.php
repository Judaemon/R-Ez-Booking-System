        ...
        <tr>
            ...
            <td>
                <div class='row'>
                    ...
                    <div class="row pt-2">  
                        <div class="col">
                            <form method="POST" action="{{route('cancelBooking',$booking->id)}}" class="cancelForm">
                                @csrf
                                @method('POST')
                                ...
                                <button booking_id="{{$booking->id}}" type='submit' class='btn  myButton w-100' 
                                        id='bookingCancelBtn' style="background-color: #f8c753; color:#fff">Cancel</button>
                            </form>
                        </div>
                    </div>                  
                    @endif     
